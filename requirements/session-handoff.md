...
## Next task
- Recommended next task: continue validation realism by tightening period-alignment and benchmark/reporting assumptions without changing scoring formulas or CLI contracts.
...
Then:
1. continue the validation-realism milestone after the residual-cash enhancement by tightening period-alignment and benchmark/reporting assumptions
